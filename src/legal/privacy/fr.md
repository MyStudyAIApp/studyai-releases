...
- **T'envoyer de temps en temps des e-mails sur les nouveautés de MyStudy** (nouvelles fonctions ou améliorations importantes du service),. Uniquement sur MyStudy, jamais sur des produits tiers. Base juridique : notre intérêt légitime et l'art. 21.2 de la LSSI espagnole (communications sur le service lui-même aux utilisateurs existants). Chaque e-mail contient un lien pour te désabonner en un clic, ce qui te désabonne aussi des e-mails de bienvenue.
