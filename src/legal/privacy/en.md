...
- **Occasionally send you emails with MyStudy news** (new features or important improvements to the service),. Only about MyStudy, never about third-party products. Legal basis: our legitimate interest and art. 21.2 of the Spanish LSSI (communications about the service itself to existing users). Every email has a link to unsubscribe in one click, which also unsubscribes you from the welcome emails.
