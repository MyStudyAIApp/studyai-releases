...
This Application uses Artificial Intelligence models across all features that process or generate content automatically: among others, summaries, explanations, quizzes, flashcards and other study materials, recording and transcribing audio to text, generating podcasts, and analyzing images or documents the User provides. The User acknowledges and agrees that these results are offered only as study support, not as a definitive source, and that they can sometimes get it wrong: with inaccuracies, errors, omissions, biases, or technical failures when processing the audio, image or document. The Owner does not guarantee pedagogical accuracy or academic success, and recommends always cross-checking generated content against official educational sources before relying on it. The User must refrain from including personal data of third parties, health data or other sensitive information in the materials they upload, write or record, since such content is transmitted to external processing providers in order to generate the result. The same applies to the answers of the help owl: they are for guidance only and, on payments, quotas or account matters, these Terms and what support indicates prevail.
Materials generated by the AI through use of the Service are granted to the registered User under a personal, non-commercial, non-exclusive license.
...
- **Free plan**: free access with a quota of 10 content generations per month (summaries, exams, flashcards, etc.), 1 podcast per month, 10 minutes/month of audio transcription and 5 scanned pages per month.
...
- **Pro plan (€15/month, recurring subscription)**: unlimited content generations; **20 podcasts per month**, **20 hours/month of audio transcription** and **500 scanned pages per month**. These are independent quotas: running out of one does not affect the others.
...
- **One-time top-ups**: to extend your quotas without changing plan — "+10 hours of transcription" (€3) and "+10 podcasts" (€7). Each top-up extends the quota named in it by the stated amount. The transcription top-up extends audio transcription hours, not scanned pages. They can only be purchased while the account has an active Pro plan.
- **Help owl**: a chat to answer questions about using the Application, free on all plans and limited to **10 questions per day** per User.
