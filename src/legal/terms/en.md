...
- **Pro plan (€15/month, recurring subscription)**: unlimited content generations; **20 podcasts per month** and **20 hours/month of transcription and image analysis**. Both share a single monthly quota of 1,200 units: each minute of recorded audio turned into text and each photographed page that is transcribed uses one unit.
