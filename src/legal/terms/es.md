...
## Lo que el Usuario debería saber de un vistazo
- Esta Aplicación no está destinada a menores de 16 años, salvo que cuenten con la autorización de sus padres o tutores legales.
...
- Los Usuarios deberán haber cumplido como mínimo 16 años o, en caso contrario, contar con la autorización expresa de sus padres o tutores legales, tanto para utilizar el Servicio como para aceptar las presentes Condiciones;
...
La Aplicación utiliza modelos de Inteligencia Artificial en todas las funciones que procesan o generan contenido automáticamente: entre otras, resúmenes, explicaciones, tests, fichas y demás materiales de estudio, la grabación y transcripción de audio a texto, la generación de podcasts y el análisis de imágenes o documentos que el Usuario le proporcione. El Usuario reconoce y acepta que estos resultados se ofrecen únicamente como ayuda para el estudio, no como fuente definitiva, y que a veces pueden salir mal: con imprecisiones, errores, omisiones, sesgos, o fallos técnicos al procesar el audio, la imagen o el documento. El Titular no garantiza la exactitud pedagógica ni el éxito académico, y recomienda contrastar siempre el contenido generado con fuentes docentes oficiales antes de darlo por bueno. El Usuario debe abstenerse de incluir en los materiales que suba, escriba o grabe datos personales de terceros, datos de salud u otra información sensible, ya que dicho contenido se transmite a proveedores externos de procesamiento para poder generar el resultado. Lo mismo se aplica a las respuestas del búho de ayuda: son orientativas y, en cuestiones de pagos, cupos o de la cuenta, prevalecen estas Condiciones y lo que indique el soporte.
Los materiales generados por la IA a partir del uso del Servicio se ceden al Usuario registrado bajo una licencia de uso personal, no comercial y no exclusiva.
...
- **Plan Free**: acceso gratuito con un cupo de 10 generaciones de contenido al mes (resúmenes, exámenes, fichas, etc.), 1 podcast al mes, 10 minutos/mes de transcripción de audio y 5 páginas escaneadas al mes.
...
- **Plan Pro (15€/mes, suscripción recurrente)**: sin límite de generaciones de contenido; **20 podcasts al mes**, **20 horas/mes de transcripción de audio** y **500 páginas escaneadas al mes**. Son cupos independientes: agotar uno no afecta a los demás.
...
- **Bonos de pago único**: para ampliar los cupos sin cambiar de plan — "+10 horas de transcripción" (3€) y "+10 podcasts" (7€). Cada bono amplía el cupo que indica su nombre en la cantidad indicada. El bono de transcripción amplía las horas de transcripción de audio, no las páginas escaneadas. Solo pueden adquirirse mientras la cuenta tenga el plan Pro activo.
- **Búho de ayuda**: chat para resolver dudas sobre el uso de la Aplicación, sin coste en todos los planes y con un máximo de **10 preguntas al día** por Usuario.
