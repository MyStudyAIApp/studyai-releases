...
- **Plan Pro (15€/mes, suscripción recurrente)**: sin límite de generaciones de contenido; **20 podcasts al mes** y **20 horas/mes de transcripción y análisis de imágenes**. Ambas cosas comparten un mismo cupo mensual de 1.200 unidades: cada minuto de audio grabado que se pasa a texto y cada página fotografiada que se transcribe consumen una unidad.
...
- **Bonos de pago único**: para ampliar los cupos sin cambiar de plan — "+10 horas de transcripción" (3€) y "+10 podcasts" (7€). Cada bono amplía el cupo que indica su nombre en la cantidad indicada; el de transcripción amplía el cupo compartido de transcripción y análisis de imágenes descrito arriba. Solo pueden adquirirse mientras la cuenta tenga el plan Pro activo.
