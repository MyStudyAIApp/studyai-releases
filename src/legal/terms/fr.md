...
- **Formule Pro (15€/mois, abonnement récurrent)** : générations de contenu illimitées ; **20 podcasts par mois** et **20 heures/mois de transcription et d'analyse d'images**. Les deux partagent un même quota mensuel de 1 200 unités : chaque minute d'audio enregistré convertie en texte et chaque page photographiée transcrite consomme une unité.
...
- **Bonus à paiement unique** : pour étendre vos quotas sans changer de formule — « +10 heures de transcription » (3€) et « +10 podcasts » (7€). Chaque bonus étend exactement le quota qu'il nomme, de la quantité indiquée ; celui de transcription étend le quota partagé de transcription et d'analyse d'images décrit ci-dessus. Ils ne peuvent être acquis que tant que le compte dispose d'une formule Pro active.
