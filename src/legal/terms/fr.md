...
Cette Application utilise des modèles d’Intelligence Artificielle dans toutes les fonctionnalités qui traitent ou génèrent du contenu automatiquement : entre autres, résumés, explications, tests, fiches et autres supports d’étude, l’enregistrement et la transcription audio-texte, la génération de podcasts, et l’analyse d’images ou de documents fournis par l’Utilisateur. L’Utilisateur reconnaît et accepte que ces résultats ne sont qu’une aide à l’étude, pas une source fiable en soi, et qu’il peut arriver qu’ils comportent des imprécisions, erreurs, omissions, biais, ou des défaillances techniques lors du traitement de l’audio, de l’image ou du document. Le Propriétaire ne garantit pas l’exactitude pédagogique ni la réussite scolaire et recommande de toujours vérifier le contenu généré auprès de sources pédagogiques officielles avant de s’y fier. L’Utilisateur doit s’abstenir d’inclure dans les supports qu’il téléverse, rédige ou enregistre des données à caractère personnel de tiers, des données de santé ou d’autres informations sensibles, ce contenu étant transmis à des prestataires de traitement externes afin de générer le résultat. Il en va de même pour les réponses de la chouette d’aide : elles sont indicatives et, pour les paiements, les quotas ou le compte, ces Conditions et les indications du support prévalent.
...
Les Utilisateurs sont seuls responsables du contenu qu’ils téléchargent, publient, partagent ou fournissent sur cette Application. Les Utilisateurs reconnaissent et acceptent que le Propriétaire ne filtre ni ne modère ce contenu .
Toutefois, le Propriétaire se réserve le droit de retirer, de supprimer ou de bloquer ce contenu, à sa discrétion, et, sans avis préalable, de refuser l’accès à cette Application à l’Utilisateur qui télécharge :
...
- si le Propriétaire est informé que le contenu, tout en étant accessible via cette Application, peut représenter un risque pour les Utilisateurs, les tiers et/ou la disponibilité du Service.
...
Les Utilisateurs s’engagent à protéger le Propriétaire contre toute réclamation revendiquée et/ou tous dommages soufferts à cause du contenu qu’ils ont fourni à cette Application ou par le biais de celle-ci.
...
### Interdiction de l’exploitation et des abus sexuels sur mineurs
Il est strictement interdit de créer, mettre en ligne ou distribuer du contenu facilitant l’exploitation ou les abus sexuels sur mineurs. Ces activités incluent tout contenu d’abus sexuels sur mineurs, entre autres.
...
- **Formule Free** : accès gratuit avec un quota de 10 générations de contenu par mois (résumés, examens, fiches, etc.), 1 podcast par mois, 10 minutes/mois de transcription audio et 5 pages numérisées par mois.
...
- **Formule Pro (15€/mois, abonnement récurrent)** : générations de contenu illimitées ; **20 podcasts par mois**, **20 heures/mois de transcription audio** et **500 pages numérisées par mois**. Ce sont des quotas indépendants : épuiser l'un n'affecte pas les autres.
...
- **Bonus à paiement unique** : pour étendre vos quotas sans changer de formule — « +10 heures de transcription » (3€) et « +10 podcasts » (7€). Chaque bonus étend exactement le quota qu'il nomme, de la quantité indiquée. Le bonus de transcription étend les heures de transcription audio, pas les pages numérisées. Ils ne peuvent être acquis que tant que le compte dispose d'une formule Pro active.
- **Chouette d’aide** : un chat pour répondre aux questions sur l’utilisation de l’Application, gratuit dans tous les forfaits et limité à **10 questions par jour** par Utilisateur.
...
Le service acheté sera accompli ou rendu accessible dans la période de temps spécifiée sur cette Application ou tel que communiqué avant la soumission de la commande.
...
Pour recevoir ou accéder à certains des Produits fournis par le biais de cette Application dans le cadre du Service, l’Utilisateur peut devoir fournir ses données personnelles comme indiqué sur cette Application. Si l’Utilisateur retire son consentement au traitement des données personnelles nécessaires à la fourniture du Service, le Propriétaire se réserve le droit de résilier le contrat.
...
Sauf exceptions applicables mentionnées ci-dessous, les Utilisateurs qui sont des Consommateurs européens bénéficient d'un droit légal de rétractation au titre des règles de l'UE, leur permettant de se rétracter des contrats conclus en ligne (contrats à distance) dans le délai spécifié applicable à leur situation, pour tout motif et sans justification à fournir.
Les Utilisateurs ne remplissant pas cette condition ne peuvent pas bénéficier des droits décrits dans la présente section.
Le Consommateur n'est responsable que de la dépréciation des biens résultant de manipulations autres que celles nécessaires pour établir la nature, les caractéristiques et le fonctionnement des biens.

### Exercer le droit de rétractation
Pour exercer leur droit de rétractation, les Utilisateurs doivent envoyer au Propriétaire une déclaration non équivoque de leur intention de se rétracter du contrat.
À cette fin, les Utilisateurs peuvent utiliser l'exemple de formulaire de rétractation disponible dans la section « définitions » du présent document.
Dans la mesure où le Propriétaire propose une telle fonctionnalité, les Utilisateurs peuvent également remplir et soumettre électroniquement l'exemple de formulaire de rétractation ou toute autre déclaration non équivoque sur cette Application. En cas d'utilisation de cette option, le Propriétaire communiquera aux Utilisateurs un accusé de réception de cette rétractation sur un support durable (p. ex. par e-mail) sans délai.
Les Utilisateurs peuvent également exercer le droit de rétractation en ligne sur cette Application. En cas d'utilisation de la fonctionnalité en ligne, le Propriétaire leur enverra un accusé de réception de la rétractation sur un support durable (p. ex. par e-mail), incluant son contenu ainsi que la date et l'heure de sa soumission, sans délai injustifié.
Les Utilisateurs sont toutefois libres d'exprimer leur intention de se rétracter du contrat par une déclaration non équivoque sous toute autre forme appropriée. Afin de respecter le délai dans lequel ils peuvent exercer ce droit, les Utilisateurs doivent envoyer la notification de rétractation avant l'expiration du délai de rétractation.
À quel moment le délai de rétractation expire-t-il ?
...
### Droit de rétractation
Sauf exception applicable stipulée ci-dessous, les Utilisateurs ayant la qualité de Consommateurs au Brésil disposent d’un droit légal de rétractation conformément à la législation brésilienne. Cela signifie que le Consommateur a le droit de résilier les contrats en ligne (contrats à distance ou conclus hors établissement) pour quelque motif que ce soit et sans justification, dans un délai de 7 (sept) jours à compter de la date de conclusion du contrat ou de la réception du produit ou du service. Les Utilisateurs qui n’ont pas la qualité de Consommateurs ne peuvent pas bénéficier des droits énoncés dans cette section. Le droit de rétractation peut être exercé par le Consommateur via les coordonnées indiquées au début de ce document et conformément aux indications de cette section.

### Exercice du droit de rétractation
Pour exercer le droit de rétractation, les Utilisateurs doivent envoyer au Propriétaire une déclaration non équivoque de leur intention de résilier le contrat. À cette fin, les Utilisateurs peuvent utiliser le modèle de formulaire de résiliation disponible dans la section « définitions » de ce document. Les Utilisateurs sont toutefois libres d’exprimer leur volonté de résilier le contrat par une déclaration non équivoque, sous toute autre forme appropriée. Afin de respecter le délai imparti pour l’exercice de ce droit, les Utilisateurs doivent envoyer l’avis de rétractation avant l’expiration du délai. Quand expire le délai de rétractation ?
- Concernant l’achat d’un service, le délai de rétractation expire 7 (sept) jours après la date de conclusion du contrat, et seulement si le service n’a pas encore été fourni.
- En cas d’achat de contenu numérique, le délai de rétractation expire 7 (sept) jours après la date de conclusion du contrat, et seulement si le contenu numérique n’a pas encore été fourni ni intégré à l’appareil du Consommateur.
...
Toutefois, les coûts supplémentaires résultant du choix d’une méthode de livraison particulière autre que le mode de livraison standard le moins coûteux proposé par le Propriétaire ne seront pas remboursés.
Ce remboursement sera effectué sans retard injustifié et, en tout état de cause, dans un délai maximum de 14 (quatorze) jours à compter du jour où le Propriétaire a été informé de la décision de l’Utilisateur de résilier le contrat ou du retour effectif du produit, selon la date la plus tardive. Sauf accord contraire avec l’Utilisateur, les remboursements seront effectués par le même moyen de paiement que celui utilisé pour la transaction initiale. En tout état de cause, l’Utilisateur ne supportera aucun coût ni frais du fait de ce remboursement.
Lorsque l’Utilisateur exerce le droit de rétractation après avoir demandé l’exécution du service, même avant l’expiration du délai de rétractation, l’Utilisateur devra payer au Propriétaire un montant proportionnel à la partie du service déjà fournie.
Ce paiement sera calculé sur la base du montant convenu contractuellement, et sera proportionnel à la partie du service fournie jusqu’au moment où l’Utilisateur résilie le service.
...
### Garantie légale de conformité des services pour les Consommateurs au Brésil
La garantie légale applicable aux services commercialisés par cette Application est régie par les conditions suivantes, conformément au Code de la Défense du Consommateur :
- les services non durables bénéficient d’une garantie de 30 (trente) jours ; et
- les services durables bénéficient d’une garantie de 90 (quatre-vingt-dix) jours.
La période de garantie débute à la fin de la prestation des services.
La garantie ne s’applique pas en cas d’usage inapproprié du service, d’événements naturels, ou si le service a fait l’objet d’une assistance technique autre que celle fournie par cette Application. La garantie peut être invoquée via les coordonnées fournies par cette Application. Si nécessaire, le Propriétaire prendra en charge les frais d’envoi de tout produit destiné à une évaluation technique. Le Propriétaire pourra également, à sa discrétion, offrir une garantie contractuelle en plus de la garantie légale. Les règles applicables aux garanties contractuelles peuvent être consultées dans les spécifications fournies par cette Application. En l’absence de telles informations, seules les dispositions légales s’appliqueront.
...
- la conduite diffamatoire, offensante ou illégale de tout Utilisateur ou tiers.
...
Le Propriétaire se réserve le droit de transférer, assigner, disposer par novation, ou sous-contracter tout ou tous droits ou obligations sous ces Conditions générales, en prenant les intérêts légitimes de l'Utilisateur en compte. Les dispositions concernant les changements de ces Conditions seront appliquées en conséquence.
...
Dans le cas où toute disposition de ces Conditions serait ou serait considérée comme nulle, invalide ou inapplicable, les parties feront de leur mieux pour trouver, de façon amiable, un accord sur des dispositions valides et applicables substituant ainsi les parties invalides, nulles ou inapplicables. A défaut de ce-faire, les dispositions nulles, invalides ou inapplicables seront remplacées par les dispositions statutaires applicables, si cela est permis ou affirmé par la loi en vigueur. Sans préjudice à ce qui précède, la nullité, l’invalidité ou l’impossibilité d’appliquer une disposition particulière de ces Conditions ne rendra pas nul l’entier Accord, à moins que les dispositions divisées ne soient essentielles à l’Accord, ou d’une telle importance que les parties n’auraient pas conclu le contrat si elles avaient su que la disposition n’était pas valide, ou dans le cas où les dispositions restantes se traduiraient en une épreuve inacceptable pour une des parties.

### Utilisateurs des États-Unis
Toute disposition invalide ou inapplicable sera interprétée, comprise et réformée dans la mesure de ce qui est raisonnablement requis pour le rendre valide, applicable et consistant avec son objectif initial. Ces Conditions constituent l’Accord entier entre les Utilisateurs et le Propriétaire en ce qui concerne le présent sujet, et dépasse toute autre communication, y compris mais sans se limiter à, tout accord antérieur entre les parties à ce sujet. Ces Conditions seront mises en application dans la pleine mesure de ce qui est permis par la Loi.
...
Si l’Utilisateur a la qualité de Consommateur brésilien et que le produit et/ou le service est commercialisé au Brésil, le droit brésilien s’applique.
...
### Exception pour les Consommateurs au Brésil
Ce qui précède ne s’applique pas aux Utilisateurs au Brésil qui ont la qualité de Consommateurs.
...
- un service permettant de créer, de traiter ou de stocker des données sous forme numérique ou d’y accéder ou permettant le partage ou toute autre forme d’interaction avec des données numériques téléversées ou créées par l’Utilisateur ou par tout autre utilisateur de cette Application.
...
Indique la ou les personne(s) ou entité légale(s) qui fournit cette Application et/ou le Service aux Utilisateurs.

### Produit
Un bien ou service accessible par le biais de cette Application, tel que des biens physiques, fichiers numériques, logiciels, services de réservation etc., et tout autre type de produits défini séparément dans les présentes, tel que les Produits Numériques.

### Service
Le service fourni par cette Application tel que décrit dans ces Conditions générales et sur cette Application.

### Conditions générales
Toutes les dispositions applicables à l’utilisation cette Application et/ou le Service tel que le décrit ce document, y compris tous autres documents ou accords, et tels que mis à jour de temps en temps.
...
### Utilisateur (ou Vous)
Indique la personne naturelle ou l’entité légale utilisant cette Application.
...
### Vos données
- Nous demander à savoir quelles informations nous détenons vous concernant et à y accéder
- Nous demander de rectifier des informations que nous détenons vous concernant
- Nous demander à exercer votre droit à l’oubli (effacer les informations que nous détenons vous concernant)
- Demander le transfert de vos données vers un autre service
- Gérer vos préférences en matière de confidentialité

### En cas de problème
Bien que nous nous efforcions de créer une expérience utilisateur positive, nous comprenons que des problèmes peuvent occasionnellement se présenter entre nous et nos utilisateurs. Si tel est le cas, n’hésitez pas à nous contacter.
